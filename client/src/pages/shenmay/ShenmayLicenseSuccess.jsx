...
const ShenmayLicenseSuccess = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-16"
      ...
      <img src={shenmayLogo} alt="Shenmay AI" className="h-8 mb-10 opacity-90" />
      ...
      <div className="w-full max-w-xl rounded-2xl border p-8 md:p-10"
        ...
        <p className="text-center mb-2" style={{ color: "rgba(255,255,255,0.70)" }}>
          Thank you for your Shenmay AI self-hosted license.
        </p>
        <p className="text-center text-sm mb-8"
           style={{ color: "rgba(255,255,255,0.55)" }}>
          We've emailed your license key — check your inbox
          (and spam folder) for a message from Shenmay AI.
        </p>
        ...
        <div className="border-t pt-6 mb-6"
          ...
          <div className="flex gap-3 p-4 rounded-lg"
            ...
            <div>
              <p className="text-sm font-medium mb-1"
                 style={{ color: "rgba(255,255,255,0.9)" }}>
                Already running Shenmay?
              </p>
              <p className="text-xs"
                 style={{ color: "rgba(255,255,255,0.55)" }}>
                Open your Shenmay dashboard (on your own server) →
