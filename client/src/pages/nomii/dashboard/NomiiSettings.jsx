...
const CompanyProfile = () => {
  const { setNomiiTenant, setNomiiUser } = useNomiiAuth();
  ...
  const save = async (e) => {
    ...
    try {
      ...
      setNomiiTenant((t) => ({ ...t, ...form, ...(res.tenant || {}) }));
      setSaved(true);
  ...
  return (
    <div className="rounded-2xl p-6 space-y-5" style={card}>
      ...
      <p className="text-[13px] text-white/40 leading-relaxed">
        ...
        Your data stays in your CRM; Nomii reads it at query time. Use this if your
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          { icon: "🔗", label: "Live Connector", desc: "Nomii calls your system in real time. Data never leaves your servers.", nav: "/nomii/dashboard/tools", navLabel: "Set up in Tools →" },
        ].map((m) => (
      ...
      <div>
        ...
        <p className="text-[11px] mt-2 text-white/20">Full API reference: <a href="https://docs.pontensolutions.com/data-api" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{ color: "#C9A84C" }}>docs.pontensolutions.com/data-api</a></p>
      </div>
    </div>
  );
};
        ...
        <div className="space-y-4">
          <div className="rounded-xl p-4 space-y-2"
            ...
            <p className="text-[12px] leading-relaxed" style={{ color: "rgba(255,255,255,0.40)" }}>
              Nomii AI fires outgoing webhooks on every key conversation event. Connect Zapier by creating a <strong className="text-white/60">Webhooks by Zapier</strong> trigger, then paste the Zapier URL into your Nomii webhook settings below.
            </p>
          </div>
          ...
          <div className="rounded-xl p-4 space-y-3"
            ...
            <ol className="space-y-2 text-[12px]" style={{ color: "rgba(255,255,255,0.38)" }}>
              ...
              <li className="flex gap-2.5">
                ...
                Trigger any event in Nomii to let Zapier detect the payload structure, then build your Zap actions.
              </li>
            </ol>
          </div>
        </div>
