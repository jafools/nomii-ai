...
import { getTeam, inviteAgent, removeAgent } from "@/lib/nomiiApi";
...
const NomiiTeam = () => {
  const { nomiiUser, subscription } = useNomiiAuth();
  ...
  const isOwner = nomiiUser?.role === "owner" || nomiiUser?.role === "member";
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl overflow-hidden" style={card}>
        ...
        {agents.map((agent, i) => {
          ...
          const isSelf = agent.id === nomiiUser?.id;
          return (
            <div
              key={agent.id}
