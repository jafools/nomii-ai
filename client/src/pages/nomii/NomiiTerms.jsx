  ...
  <div className="min-h-screen bg-[#FAFAFA]">
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <Section number={1} title="Service Description">
        <p>
          Nomii AI ("the Service") is an AI-powered customer engagement platform provided by Pontén Solutions LLC. The Service enables businesses ("Tenants") to deploy conversational AI agents on their websites and digital properties to interact with their end customers.
        </p>
        <p>
      ...
      <Section number={6} title="Changes to These Terms">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Display a prominent notice in the Nomii AI dashboard.</li>
